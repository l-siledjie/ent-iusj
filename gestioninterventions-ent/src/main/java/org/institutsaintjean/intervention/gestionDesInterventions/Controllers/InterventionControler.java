...
public class InterventionControler {
    ...
    public Intervention creerIntervention(@PathVariable("codeEtudiant") Long codeEtudiant,
        ...
        return interventionService.creerIntervention(codeEtudiant, idCategorie, fichiers, file, DescriptionIntervention,
                idSousIntervention);
    }
    ...
    // MultipartFile file, @RequestParam("nomDepartement") String nomDepartement) {
    ...
    // String filePath = "C:\\Users\\pc\\Desktop\\gestIntervention\\" +
    ...
    // public ResponseEntity<Resource> downloadPieceJointe(@PathVariable Long
    // interventionId) {
    // try {
    ...
    // } catch (IOException e) {
    // e.printStackTrace();
    // // Gérez l'exception selon vos besoins, par exemple, retournez une réponse
    // d'erreur appropriée
    ...
    // public ResponseEntity<Resource> telechargerPieceJointe(@PathVariable Long
    // idPieceJointe) throws IOException {
    // // Récupérer la pièce jointe par son ID
    // PieceJointe pieceJointe =
    // interventionService.getPieceJointeById(idPieceJointe);
    //
    // // Créer un InputStreamResource à partir du contenu de la pièce jointe
    // InputStreamResource resource = new InputStreamResource(new
    // ByteArrayInputStream(pieceJointe.getContenu()));
    //
