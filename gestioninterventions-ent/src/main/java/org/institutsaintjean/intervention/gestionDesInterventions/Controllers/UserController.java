...
public class UserController {
    ...
    @GetMapping("/Users/infos/{idPersonnel}")
    public Personnel UserEnFonctionDeId(@PathVariable long idPersonnel) {
        return personnelRepository.findByIdPersonnel(idPersonnel);
    }
